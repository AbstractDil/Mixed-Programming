...
for (var totalMarks = 0, s = 0; s < 1; s++) {
  ...
  for ( var right = 0,notAttempted = 0, bonus = 0, i = 200 * s;i < 200 * s + 200;i++) {
    " -- " ===
      document
  ...
  (wrong = 200 - notAttempted - right - bonus),
