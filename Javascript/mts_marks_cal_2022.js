  ...
  for ( var right = 0,notAttempted = 0, bonus = 0, i = 20 * s;i < 20 * s + 20;i++) {
    " -- " ===
      document
        ...
        [i].getElementsByClassName("bold")[6].textContent && notAttempted++;
    ...
    try {
      document
        ...
        document
          .getElementsByClassName("question-pnl")
          [i].getElementsByClassName("bold")[6].textContent && right++;
    } catch {
      bonus++;
    }
  }
...
for (var totalMarks_II = 0, s = 2; s < 4; s++) {
  ...
  for ( var right = 0,notAttempted = 0, bonus = 0, i = 25 * (s-2);i < 25 * (s-2) + 25;i++) {
    //console.log(i);
    " -- " ===
    document.getElementsByClassName("grp-cntnr")[1].getElementsByClassName("question-pnl")[i].getElementsByClassName("bold")[6].textContent && notAttempted++;
